...
export default function Admin() {
  ...
  const [salesLoaded, setSalesLoaded] = useState(true)
      ...
      <main className="adm-main">
        ...
        <div className="adm-stats">
          ...
          <div className="adm-stat">
            ...
            <div className="adm-stat-value">{new Set(events.map(e => e.category)).size}</div>
          ...
          {tab === TAB_SALES ? (
            <div className="adm-stat">
              ...
              <div className="adm-stat-value">{`${totalApproved.toFixed(0)}€`}</div>
                    ...
                    return (
                      <tr key={ev.idEvent}>
                        ...
                        <td style={{ display: 'flex', gap: '0.4rem', alignItems: 'center', flexWrap: 'wrap' }}>
                          ...
                          <button className="adm-delete-btn" onClick={() => handleDeleteEvent(ev.idEvent)}>
